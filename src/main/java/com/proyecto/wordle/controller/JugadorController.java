...
import com.proyecto.wordle.dto.JugadorModDTO;
...
public class JugadorController {
    ...
    public Jugador getJugadorbyId(@PathVariable Long id){
        return jugadorRepository.findById(id)
                .orElseThrow(() -> new JugadorNoEncontrado(id));
    }
    ...
    public ResponseEntity<Void> deleteJugadorById(@PathVariable Long id){
        Jugador jugador = jugadorRepository.findById(id).orElseThrow(() -> new JugadorNoEncontrado(id));
    ...
    public ResponseEntity<?> newJugador(@RequestBody JugadorModDTO nuevojug){
    ...
    public Jugador updateJugador(@RequestBody JugadorModDTO newJugador, @PathVariable Long id){
        Equipo equipo = null;
